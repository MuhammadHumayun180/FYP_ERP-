        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
                    <h3 class="h3 mb-0 text-gray-800">Add Payroll</h3>
                    ...
                    <div class="container-fluid mt-5">
                        ...
                        <form action="{{ route('admin.payroll.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select form-control @error('employee_id') is-invalid @enderror {{ old('employee_id') ? 'is-valid' : ' ' }} " id="employee_id" name="employee_id">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('basic_salary') is-invalid @enderror {{ old('basic_salary') ? 'is-valid' : ' ' }}" id="basic_salary" name="basic_salary" value="{{ old('basic_salary') }}" readonly>
                                @error('basic_salary')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control  @error('office_timing') is-invalid @enderror {{ old('office_timing') ? 'is-valid' : ' ' }}" id="office_timing" name="office_timing" readonly>
                                @error('office_timing')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('lateness_deductions') is-invalid @enderror {{ old('lateness_deductions') ? 'is-valid' : ' ' }}" id="lateness_days" name="lateness_deductions" value="{{ old('lateness_deductions') }}" readonly >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('leave_days_deductions') is-invalid @enderror {{ old('leave_days_deductions') ? 'is-valid' : ' ' }}" id="leave_days_deductions" name="leave_days_deductions" value="{{ old('leave_days_deductions') }}" readonly >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('deductions') is-invalid @enderror {{ old('deductions') ? 'is-valid' : ' ' }}" id="deductions" name="deductions" value="{{ old('deductions') }}" readonly>
                                @error('deductions')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('deducted_salary') is-invalid @enderror {{ old('deducted_salary') ? 'is-valid' : ' ' }}" id="deducted_salary" name="deducted_salary" value="{{ old('deducted_salary') }}" readonly >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('allowances') is-invalid @enderror {{ old('allowances') ? 'is-valid' : ' ' }}" id="allowances" name="allowances" value="{{ old('allowances') }}" >
                                @error('allowances')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('overtime_earnings') is-invalid @enderror {{ old('overtime_earnings') ? 'is-valid' : ' ' }}" id="overtime_earnings" name="overtime_earnings" value="{{ old('overtime_earnings') }}" >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('payment_date') is-invalid @enderror {{ old('payment_date') ? 'is-valid' : ' ' }}" id="payment_date" name="payment_date" value="{{ old('payment_date') }}" >
                                @error('payment_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            if (employeeId) {
                ...
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        ...
                        toastr.error('Time Attendance Not Found');
