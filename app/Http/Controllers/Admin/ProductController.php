        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)->addIndexColumn()
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <a href='".route('admin.product-edit',$row->id)."' class='edit btn btn-success btn-sm mx-1'>Edit</a>
                    <a href='".route('admin.product-delete',$row->id)."' class='delete btn btn-danger btn-sm mx-1'>Delete</a>
                    </div>";
                    return $actionBtn;
                })
                ->rawColumns(['action'])
